...
# ─── AYARLAR ─────────────────────────────────────────────────────────────────
INPUT_EXCEL    = "sonuclar_NFS_guncel_isp6_3000req.xlsx"
NETWORK_FOLDER = "topologies/guncel/NSFNET"   # NSFNET veya USNET
# ─────────────────────────────────────────────────────────────────────────────
...
def main(input_excel=None):
    ...
    for row_idx in range(2, ws.max_row + 1):
        ...
        for algo in ALGOS:
            ...
            delays[(row_idx, algo)] = result if result is not None else "Hata"
